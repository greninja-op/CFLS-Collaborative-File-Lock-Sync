...
status bar. Select it (or run **CFLS: Show Coordination Status**) to open active
member task and repository-relative file metadata, alongside presence, locks,
declared intents, and coordination warnings.
